...
<main>
  <div class="container">
    ...
    <div class="row">
      <div  class="col section no-pad-top" style="width:100%; max-width:1023px;">
        <div class="video-container z-depth-1">
          <iframe src="https://player.vimeo.com/video/192820464?byline=0"  frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
        </div>
      </div>
    </div>
    ...
    <div class="row">
      <div  class="col section no-pad-top" style="width:100%; max-width:1023px;">
        <div class="video-container z-depth-1">
          <iframe src="https://player.vimeo.com/video/192954003?byline=0"  frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
        </div>
      </div>
    </div>
